...
if (header!="#CSDroidMap#") {show_message("Map is not valid!") buffer_delete(buff) return -1;}
//first code
...
switch (type)
  ...
  case 4:var k=room_instance_add(global.rm,xx,yy,obj_whether); k.type=dat[1];break;
  }
}
